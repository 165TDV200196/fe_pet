...
import { bar, iconLogin, iconLogout, search, userHome } from "../../Admin/svg/IconSvg";
        ...
        <div className="Menu" ref={MenuEl}>
            ...
            <div id="menu-hide" ref={MenuHidentEl} style={{ display: "flex" }}>
                <div className="menu-item">
                    <div className="list-item">
                        <ul>
                            ...
                            <li className="item">
                                <Link to="/ListNews">Tin tức_</Link>
                            </li>
                            {user?.role === "admin" && (
                                <li className="item">
                ...
                <div className="menu-account">
                    ...
                    <Cart />
                    {openSelect === "" && <div className="blur" onClick={ClickAvatar}></div>}
                    <div
