                                ...
                                <Grid item lg={4} md={4} sm={4} xs={12}>
                                    <div className="item">
                                        ...
                                        <div className="text">
                                            ...
                                            những thú cưng quý tộc. Chắc chắn rồi tôi sẽ sớm quay
                                            lại.
                                        </div>
                                ...
                                <Grid item lg={4} md={4} sm={4} xs={12}>
                                    <div className="item">
                                        ...
                                        <div className="text">
                                            ...
                                            thiên đường với chú cún của tôi vậy, tôi có thể thấy
                                            được sự hạnh phúc hiện rõ trên khuôn mặt nó.
                                        </div>
                                        <div className="icon end">
                                            <svg
                                                aria-hidden="true"
                                ...
                                <Grid item lg={4} md={4} sm={4} xs={12}>
                                    <div className="item">
                                        ...
                                        <div className="text">
                                            ...
                                            thể tạo hình y như trong những bức hình tôi cho anh ta
                                            xem vậy, những người thợ ở đây phải là những người thợ
                                            đẳng cấp 5 sao.
                                        </div>
                                        <div className="icon end">
                                            <svg
