...
export default function Payment({ onClose, statusDialog, userInfor, listCart }) {
    ...
    return (
        <div className="payment">
            <Dialog open={statusDialog} onClose={handleClose} aria-labelledby="form-dialog-title">
                ...
                <DialogActions>
                    ...
                    <Button id="hello" onClick={handleAgreePopConfirm} color="secondary">
                        Đồng ý
                    </Button>
                </DialogActions>
                <Dialog
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-slide-description">
                            Bạn đồng ý tiếp tục tiến hành giao dịch?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
