            ...
            <Container maxWidth="lg">
                <div className="post-gird">
                    ...
                    <div className="post-item">
                        ...
                        <span>
                            Để bảo vệ sức khỏe của vật nuôi bạn cần biết cách chăm sóc thú cưng đúng
                            cách. Vì vậy, chúng tôi cung cấp các dịch vụ tạo ra lộ trình chăm sóc
                            thú cưng của bạn, vật nuôi của bạn 1 cách an toàn nhất.
                        </span>
                    </div>
                    <div className="post-item">
                        <img src={imgCat} alt="" />
                        <div className="item-content">
                            <div className="text">
                                <h2>Giá cả hợp lý</h2>
                                <span>
                                    Có từng loại dịch vụ phù hợp với đại đa số những người yêu thích
                                    thú cưng khắp cả nước.
                                </span>
                            </div>
                        </div>
