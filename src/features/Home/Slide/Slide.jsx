...
export default function Slide() {
    ...
    useEffect(() => {
        ...
        let slideIndex = 0;
        const slideShow = (n) => {
            let slideActive = slideEl.current.querySelector(".slide-item.slide-active");
        ...
        <div className="Slide">
            <div className="slideWrapper">
                <div className="slides" ref={slideEl}>
                    ...
                    <div className="slide-item slide-active" style={{ color: "#978e79 " }}>
                        <img src={imgCat} alt="" />
                        <div className="slide-content">
                            <h1>01</h1>
                            <h3>Mèo ZumBa</h3>
                            <div className="hr"></div>
                            <span>Cung cấp các dịch vụ chăm sóc đặc biệt cho thú cưng của bạn</span>
                            <br />
