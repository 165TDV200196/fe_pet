...
export const weight = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    class="svg-inline--fa fa-weight fa-w-16 fa-3x"
  >
    <path
      fill="currentColor"
...
export const contact = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 576 512"
    class="svg-inline--fa fa-id-card-alt fa-w-18 fa-3x"
  >
    <path
      fill="currentColor"
...
export const cat = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
    class="svg-inline--fa fa-cat-space fa-w-20 fa-3x"
  >
    <path
      fill="currentColor"
...
export const useCheck = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
    class="svg-inline--fa fa-user-check fa-w-20 fa-3x"
  >
    <path
      fill="currentColor"
...
export const check = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 448 512"
    class="svg-inline--fa fa-check fa-w-14 fa-3x on"
  >
    <path
      fill="currentColor"
...
export const notCheck = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 448 512"
    class="svg-inline--fa fa-check fa-w-14 fa-3x red"
  >
    <path
      fill="currentColor"
      d="M413.505 91.951L133.49 371.966l-98.995-98.995c-4.686-4.686-12.284-4.686-16.971 0L6.211 284.284c-4.686 4.686-4.686 12.284 0 16.971l118.794 118.794c4.686 4.686 12.284 4.686 16.971 0l299.813-299.813c4.686-4.686 4.686-12.284 0-16.971l-11.314-11.314c-4.686-4.686-12.284-4.686-16.97 0z"
...
export const petCheckNull = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    class="svg-inline--fa fa-record-vinyl fa-w-16 fa-3x"
  >
    <g class="fa-group">
      <path
        fill="currentColor"
...
export const category = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    class="svg-inline--fa fa-dice-d12 fa-w-16 fa-3x"
  >
    <path
      fill="currentColor"
...
export const product = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 640 512"
    class="svg-inline--fa fa-bone fa-w-20 fa-3x"
  >
    <path
      fill="currentColor"
