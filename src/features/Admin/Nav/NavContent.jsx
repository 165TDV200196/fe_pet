    ...
    return (
        <div className="NavContent">
            <Switch>
                ...
                <Route exact path={`${path}/CheckPet/PetDetail/:id`} component={PetDetail} />
                ...
                <Route exact path={`${path}/Bill/DetailBill/:id`} component={BillDetail} />
                ...
                <Route exact path={`${path}/Category/AddCategory`} component={AddCategory} />
                <Route exact path={`${path}/Category/AddCategory/:id`} component={AddCategory} />
                <Route exact path={`${path}/Product`} component={Product} />
                <Route exact path={`${path}/Product/AddProduct`} component={AddProduct} />
                <Route exact path={`${path}/Product/AddProduct/:id`} component={AddProduct} />

                <Route exact path={`${path}/Service`} component={Service} />
                <Route exact path={`${path}/Service/AddService`} component={AddService} />
                <Route exact path={`${path}/Service/AddService/:id`} component={AddService} />
                <Route exact path={`${path}/Gallery`} component={Gallery} />
                <Route exact path={`${path}/Gallery/AddGallery`} component={AddGallery} />
                <Route exact path={`${path}/Gallery/AddGallery/:id`} component={AddGallery} />
                <Route exact path={`${path}/Weight`} component={Weight} />
                <Route exact path={`${path}/Weight/AddWeight`} component={AddWeight} />
                <Route exact path={`${path}/Weight/AddWeight/:id`} component={AddWeight} />
                <Route exact path={`${path}/Contact`} component={Contact} />
                <Route exact path={`${path}/Contact/AddContact`} component={AddContact} />
                <Route exact path={`${path}/Contact/AddContact/:id`} component={AddContact} />
